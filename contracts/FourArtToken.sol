...
contract FourArtToken is ERC20Burnable, Pausable, Feeless {
    // minter variable(owner)

    constructor() payable ERC20("4ARTToken", "4Art") Ownable() {
        _mint(_msgSender(), 2991500000e18);
    }
    ...
    function transferForSigning(address to, uint256 amount) external feeless {
